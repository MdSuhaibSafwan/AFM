...
from administration.models import CustomUser, Mentor
...
def Booking(request):  # , slug
    ...
    if request.is_ajax and request.method == 'POST':
        ...
        service = UserServices.objects.get(id=post_data['selected_service'])
        ...
        app = Appointment.objects.create(
            ...
            services=service.service, cost=post_data['cost'], currency=post_data['currency'],
        ...
        # return JsonResponse({
        #                         'link': f'<a target=blank, href="http://127.0.0.1:8000/booking/confirm/{app.id}/">{request.user.first_name} sent you an offer, click here to accept</a>'},
        #                     status=200)
        # link = f"{request.user.first_name} sent you an offer, click <a href='http://127.0.0.1:8000/booking/confirm/{app.id}/' > here</a> to accept"
        link = f"{request.user.first_name} sent you an offer, click <a href='https://afi-applypeer-2du4s.ondigitalocean.app/booking/confirm/{app.id}/' > here</a> to accept"
        return JsonResponse({
            'link': link},
            status=200)
...
def ApproveAppointment(request, pk):
    ...
    if request.is_ajax and request.method == 'POST':
        ...
        return render(request, 'appointments/book.html', {'appointment': obj, 'paypal_merchant_id': paypal_merchant_id,
                                                          'link': 'https://afi-applypeer-2du4s.ondigitalocean.app/'})
    ...
    if request.user.user_type == 0:
        ...
        if request.method == 'POST':
            ...
            if form.is_valid():
                ...
                link = f"{obj.provider.first_name} sent you an offer, click <a href='https://afi-applypeer-2du4s.ondigitalocean.app/booking/confirm/{obj.id}/' > here</a> to accept"
