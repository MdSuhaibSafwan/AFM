            ...
            if mentor_onboard_obj.exists():
                ...
                json_data = {
                    ...
                    "partner_config_override": {
                        "return_url": "https://afi-applypeer-2du4s.ondigitalocean.app/booking/mentor-service",
                    },
                    'legal_consents': [
                        {
...
# headers = {
        ...
        # data = '{ "url": "https://afi-applypeer-2du4s.ondigitalocean.app/paypal-webhook/", "event_types": [ { "name": "CHECKOUT.CHECKOUT.BUYER-APPROVED" }, { "name": "CHECKOUT.ORDER.COMPLETED" }, { "name": "CHECKOUT.ORDER.VOIDED" }, { "name": "MERCHANT.ONBOARDING.COMPLETED" }, { "name": "ERCHANT.PARTNER-CONSENT.REVOKED" }, { "name": "CHECKOUT.ORDER.APPROVED" } ] }'
