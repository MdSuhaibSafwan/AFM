...
class Mentor(models.Model):
    ...
    institute_name = models.CharField(max_length=30, null=True, blank=True)
    ...
    book_appointment_link = models.URLField(max_length=200, null=True)
