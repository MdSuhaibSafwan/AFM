...
urlpatterns = [
    ...
    path('peer-medical-school-application-community/', views.registration, name='registration'),
    path('register-now-to-start-medical-school-abroad/', views.redirect_registration, name='redirect_registration'),
    path('peer-medical-school-application-community/<str:mentor_slug>/', views.registration, name='registration'),
    ...
    # **************** STUDENT MODULES *****************
    path('search-mentors/', views.search_mentors_twfl, name='search_mentors_twfl'),
    ...
    # **************** ADMIN MODULES *****************
    path('list-mentors/', views.list_mentors_twfl, name='list_mentors_twfl'),
    ...
    path('approve-mentor/<str:admin_slug>/', views.approve_mentor_twfl, name='approve_mentor_twfl'),
    ...
    # **************** MENTOR MODULES *****************
    path('students/', views.list_students_twfl, name='list_students_twfl'),
    ...
    path('my-profile/<str:slug>/', views.student_profile_twfl, name='my_profile'),
    path('mentor-profile/<str:slug>/', views.mentor_profile_twfl, name='mentor_profile'),
