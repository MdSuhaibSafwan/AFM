...
class Application(models.Model):
    ...
    would_you_like_our_alumni_to_assist_you_in_english_skills = models.IntegerField(null=True,
                                                                                            choices=questions_choice)

    would_you_like_gain_additional_work_experience = models.IntegerField(null=True, choices=questions_choice)

    would_you_be_interested_in_sharing_your_details_with_institute = models.IntegerField(null=True,
                                                                                         choices=questions_choice)
...
class AcademicQualification(models.Model):
    ...
    grades_achieved = models.CharField(null=True, max_length=100, )
